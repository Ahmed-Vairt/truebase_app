...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype._create = function () {
        ...
        this.element.append(
            ...
            <ul> \
            <li data-criterion="length" class="invalid"><i></i> 8-20 <strong>Characters</strong></li> \
            <li data-criterion="capital" class="invalid"><i></i> At least <strong>one capital letter</strong></li> \
            <li data-criterion="number" class="invalid"><i></i> At least <strong>one number</strong></li> \
            <li data-criterion="letter" class="invalid"><i></i> At least <strong>one Special characters</strong></li> \
            </ul> \
            </div>');
    ...
    Plugin.prototype._bind_input_events = function($s) {
        ...
        $s.bind('keyup', function () {
            ...
            var character = password.match(/[!%^()+@$,<>#:?_*&;]/g) ? 1 : 0;
